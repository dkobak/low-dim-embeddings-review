# 
# This code implements SQuadMDS, a fast approximation of MDS. It can be downloaded from 'https://github.com/PierreLambert3/SQuaD-MDS-and-FItSNE-hybrid'. 
# Author: Pierre Lambert, UCLouvain. 
# Related paper: Lambert, P., De Bodt, C., Verleysen, M., & Lee, J. A. (2022). SQuadMDS: A lean Stochastic Quartet MDS improving global structure preservation in neighbor embedding like t-SNE and UMAP. Neurocomputing, 503, 17-27.
# 
