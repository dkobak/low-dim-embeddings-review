...
# Runtimes can also be estimated (in this case, the original Kanton et al data must be downloaded as detailed in the README and preprocessed by running kanton-preprocess.py) and embeddings are computed using several hyper-parameter values. Embeddings of subsamplings of this data set can also be computed. 
